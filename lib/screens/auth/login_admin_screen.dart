...
import 'package:arcular_plus/screens/superadmin/superadmin_dashboard_screen.dart';
...
class _LoginAdminScreenState extends State<LoginAdminScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Fetch staff info from /api/admin/staff/<firebaseUid>
      final backendUser = await ApiService.getStaffInfo(user.uid);
      if (backendUser == null) {
        setState(() {
      ...
      if (role == 'superadmin') {
        ...
        setState(() {
          _errorMessage = 'Access denied: Not Superadmin.';
        });
      }
    } catch (e) {
      setState(() {
